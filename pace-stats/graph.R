...
ggsave(filename="/tmp/ph1000k.pdf", height=4, width=7)

th1000k <- ggplot(hashes1000k, aes(window)) + geom_line(aes(y = time))

ggsave(filename="/tmp/th1000k.pdf", height=4, width=7)
...
ggsave(filename="/tmp/psh1000k.pdf", height=4, width=7)

tsh1000k <- ggplot(shashes1000k, aes(window)) + geom_line(aes(y = time))

ggsave(filename="/tmp/tsh1000k.pdf", height=4, width=7)
